...
const List stalemates = [
  '1R6/8/8/8/8/8/7R/k6K b - - 0 1',
  '8/8/5k2/p4p1p/P4K1P/1r6/8/8 w - - 0 2',
];

const List positionsInsufficientMaterial = [
  {
    'fen': 'rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1',
    'draw': false
  },
...
List positionsThreefoldRepetition = [
  {
    'fen': 'rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1',
...
const List positionsAlgebraicNotation = [
  {
...
List positionsGetPutRemove = [
  {
    'pieces': {
      'a7': Piece(PAWN, WHITE),
      'b7': Piece(PAWN, BLACK),
      'c7': Piece(KNIGHT, WHITE),
      'd7': Piece(KNIGHT, BLACK),
      'e7': Piece(BISHOP, WHITE),
      'f7': Piece(BISHOP, BLACK),
      'g7': Piece(ROOK, WHITE),
      'h7': Piece(ROOK, BLACK),
      'a6': Piece(QUEEN, WHITE),
      'b6': Piece(QUEEN, BLACK),
      'a4': Piece(KING, WHITE),
      'h4': Piece(KING, BLACK)
    },
    'should_pass': true
  ...
  {
    'pieces': {'j4': Piece(PAWN, WHITE)}, // bad square
    'should_pass': false
  },
];
...
const List positionsValidateFEN = [
  {
